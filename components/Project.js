...
const Project = () => {
    ...
    return (
        <div className='flex justify-center flex-col mt-24 w-full mx-auto'>
            <h1 className='flex font-bold text-4xl mb-5 justify-center' data-aos="fade-down">My Projects</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8  px-12  " data-aos="zoom-in">
                {/* //cards 1 */}
